...
void runBrainLedAnimation() {
  ...
  for (const auto& wave : waves) {
    auto frame = getInterpolatedFrame(frames, wave.center, wave.hue, wave.tailWidth);
...
void setup() {
  ...
  FastLED.setBrightness(BRAIN_BRIGHTNESS); // Default global brightness (can override per strip)
